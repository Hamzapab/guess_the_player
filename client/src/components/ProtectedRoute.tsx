        ...
        <div className="fixed inset-0 z-50 w-full h-screen flex items-center justify-center">
          <div className="relative">
            <svg
              ...
              className="h-20 w-auto block mx-auto"
            >
              <svg
                id="Layer_1"
                data-name="Layer 1"
              ...
              >
                <path
                  className="path-0 animate-[pulse_1s_infinite] [animation-delay:-0.125s]"
                ...
                />
                <path
                  className="path-1 animate-[pulse_1s_infinite] [animation-delay:-0.25s]"
                  d="M97.55,38.68A43.76,43.76,0,0,1,98,33.44c.41-2.36-.5-3.57-2.57-4.64C91.1,26.59,87,24,82.66,21.82a6.18,6.18,0,0,0-4-.71C73.45,22.55,68.32,24.25,63.22,26c-3.63,1.21-6.08,3.35-5.76,7.69a26.67,26.67,0,0,1-.6,4.92c-1.08,8.06-1.08,8.08,5.86,11.92,3.95,2.19,7.82,5.75,11.94,6.08s8.76-2.41,13.12-3.93c9.33-3.29,9.33-3.3,9.78-14Z"
                  fill="#22D3EE"
                />
                <path
                  className="path-2 animate-[pulse_1s_infinite] [animation-delay:-0.375s]"
                ...
                />
                <path
                  className="path-3 animate-[pulse_1s_infinite] [animation-delay:-0.5s]"
                ...
                />
                <path
                  className="path-4 animate-[pulse_1s_infinite] [animation-delay:-0.625s]"
                ...
                />
                <path
                  className="path-5 animate-[pulse_1s_infinite] [animation-delay:-0.75s]"
                  fill="#22D3EE"
                ...
                />
                <path
                  className="path-6 animate-[pulse_1s_infinite] [animation-delay:-0.875s]"
                  fill="#22D3EE"
                ...
                />
                <path
                  className="path-7 animate-[pulse_1s_infinite] [animation-delay:-1s]"
                  fill="#22D3EE"
                  d="M66.28,132.51c13.36,3.78,25.62,3.5,38-.9C91.68,129.59,79.36,128,66.28,132.51Z"
                />
                <path
                  className="path-8 animate-[pulse_1s_infinite]"
                  fill="#22D3EE"
                ...
                />
                <path
                  className="bb-9 animate-[pulse_1s_infinite]"
                  fill="#22D3EE"
